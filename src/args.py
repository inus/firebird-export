...
def get_args():
    ...
    parser.add_argument('-l', '--limit', action='store_true', default=False, help="Limit tables and fields to those in customselect.py")
    parser.add_argument('-m', '--maxrows', help="Max number of rows returned in export")

    #fixme - numsamples to be conditional on sampledata
    parser.add_argument('-s', '--sampledata', action='store_true', default=False, help="Also show sample record")
